...
exports.VAV_SIZES = exports.HAP_WINTER_LOADS = exports.HAP_SUMMER_LOADS = exports.WALL_U_VALUES = exports.FACADE_TYPES = exports.OCC_SENSIBLE_BY_TEMP = exports.DESIGN_DATA = void 0;
exports.getOccupantLoads = getOccupantLoads;
exports.selectVAV = selectVAV;
exports.DESIGN_DATA = {
...
function getOccupantLoads(roomTempC) {
    // Find two nearest points and linearly interpolate
    const sorted = [...exports.OCC_SENSIBLE_BY_TEMP].sort((a, b) => Math.abs(a.temp - roomTempC) - Math.abs(b.temp - roomTempC));
    ...
    const p2 = sorted[1];
    if (p1.temp === p2.temp)
        return { sensible: p1.sensible, latent: p1.latent };
...
function selectVAV(saFinalLs) {
    return exports.VAV_SIZES.find((v) => v.maxLs >= saFinalLs) ?? null;
}
