...
exports.autoSizeEquipment = autoSizeEquipment;
function autoSizeEquipment(loadKw, areaM2, supplyLs, zoneType) {
    let systemType;
    if (areaM2 < 50 || zoneType === 'server')
        systemType = 'Split System';
    else if (areaM2 < 200 && zoneType !== 'lab')
        systemType = 'FCU';
    else
        systemType = 'AHU';
